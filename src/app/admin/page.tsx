        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-3 w-full md:w-auto overflow-x-auto pb-2 md:pb-0">
              <Link href="/kitchen" className="flex items-center gap-2 px-5 py-2.5 bg-blue-50 text-blue-700 hover:bg-blue-100 rounded-xl font-bold transition-colors whitespace-nowrap">
                <UtensilsCrossed size={18} /> Kitchen
              </Link>
              <Link href="/stats" className="flex items-center gap-2 px-5 py-2.5 bg-purple-50 text-purple-700 hover:bg-purple-100 rounded-xl font-bold transition-colors whitespace-nowrap">
                <BarChart3 size={18} /> Stats
              </Link>
              <Link href="/display" className="flex items-center gap-2 px-5 py-2.5 bg-green-50 text-green-700 hover:bg-green-100 rounded-xl font-bold transition-colors whitespace-nowrap">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
           ...
           <div className="lg:col-span-2 grid grid-cols-2 gap-4">
              ...
              <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl p-6 text-white shadow-lg shadow-green-200 transform hover:scale-[1.02] transition-all">
                ...
                <div className="text-3xl font-black truncate">{formatCurrency(stats.revenue)}</div>
              </div>
           ...
           {/* Kolom Kanan: STOCK MANAGER (READ ONLY) */}
           <div className="lg:col-span-1 flex flex-col h-full">
              <StockManager readOnly={true} />
           </div>
        </div>
